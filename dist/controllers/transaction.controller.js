    ...
    try {
        ...
        if (typeof transactionData.purchasedItems === "string") {
            try {
                ...
                res.status(400).json({ message: "Invallid format for purchasedItems" });
                return;
            }
        }
        ...
        res.status(500).json({ message: "Error crerating transaction", e });
    }
});
...
const getTransactions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({ message: "Error fetching transaction", e });
    }
});
...
const updateTransaction = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({ message: "Error updating transaction status", e });
    }
});
